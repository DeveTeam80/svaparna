            ...
            <div className="space-y-6 text-left">
              ...
              <div className="space-y-4 text-sm text-primary-brand/85 leading-relaxed font-light">
                ...
                <p>
                  ...
                  with USA's premier Ayurvedic training councils. The outcome is
                  **Svaparna Health**—a haven where each patient holds control
                  over their path, restoring natural biomechanics while
                  achieving deep mental, physiological, and emotional balance.
                </p>
              </div>
